<template>
  <div class="lastOrders">
      <Breadcrumb>
        ...
        <BreadcrumbItem>已完成订单</BreadcrumbItem>
    </Breadcrumb>
...
<script>
  ...
  export default {
      ...
      data() {
      return {
        tips: ['商品', '订单金额', '订单状态', '操作'],
        allOrders:[
            {
                orderNumber:'ASOS20190103001',
                orderTime:'2019-01-02 15:30:45',
                orderImg:'',
                orderDetail:{
                    orderTitle:'安孚体检通套餐A',
                    orderFeature:'特色：一卡在手 多家体检',
                    orderServer:'服务：★项目全面 体检完善...'
                },
                orderPrice:360,
                orderStatus:'已完成',
            },
            {
                orderNumber:'ASOS20190103002',
                orderTime:'2019-01-02 15:30:45',
                orderImg:'',
                orderDetail:{
                    orderTitle:'安孚体检通套餐B',
